...
# Release/version ownership belongs to the version-specific validator (validate_v412.py).
# This validator checks the Intelligence Center feature contract only.
req('backend/app/main.py', 'app.include_router(intelligence_router)')
...
print('failed-run recovery + Shanghai-local daily summary + async local KB QA + serial AI queue UI present')
